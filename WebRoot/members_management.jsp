					...
					xmlHttpRequest.onreadystatechange = function() {
						if (
							...
							for (var i = 0; i < jsonObj.length; i++) {
								...
								if (jsonObj[i]["STATUS"] == 1) liHTML += "<p>正常</p>";
								else liHTML += "<p>黑名单</p>";
								liHTML +=
								'</div><div class="column4"><button type="button">修改会员资料</button><br><button type="button">充值</button><button type="button">挂失</button><button type="button">删除</button><br><button type="button">查看购书记录</button></div></li>';
	...
	<body>
		...
		<div id="layer">
			<div id="window">
				...
				<span class="not-block">购书数量</span>
				<input type="number" />
